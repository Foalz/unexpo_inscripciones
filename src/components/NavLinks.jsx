...
const ITEMS = [
  ...
  { id: 'admin_login', label: 'Admin', icon: Shield, match: (v) => v.startsWith('admin') },
  { id: 'about', label: 'Acerca de', icon: Info, match: (v) => v === 'about' },
]

export function NavLinks({ currentView, onViewChange, theme = 'light' }) {
